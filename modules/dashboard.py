...
def render():
    ...
    <div style='padding: 32px 0 24px 0'>
        ...
        <div class='hero-subtitle'>Volatile Organic Compounds · Insect–Plant Interactions · Cheminformatics</div>
    </div>
    ...
    with col_a:
        st.markdown("<div class='section-head'>Bioactivity Distribution</div>", unsafe_allow_html=True)
    ...
    with col_b:
        st.markdown("<div class='section-head'>Chemical Classes</div>", unsafe_allow_html=True)
    ...
    with col_c:
        st.markdown("<div class='section-head'>LogP vs MW by Bioactivity</div>", unsafe_allow_html=True)
        fig3 = px.scatter(
            VOCS, x="mw", y="logp",
            color="bioactivity",
            symbol="class",
    ...
    with col_d:
        st.markdown("<div class='section-head'>Emission Source Breakdown</div>", unsafe_allow_html=True)
    ...
    # ── Recent Records ───────────────────────────────────────────────────────
    st.markdown("<div class='section-head'>Recent VOC Records</div>", unsafe_allow_html=True)
    ...
    st.dataframe(
        styled.style.applymap(color_bio, subset=["bioactivity"]),
